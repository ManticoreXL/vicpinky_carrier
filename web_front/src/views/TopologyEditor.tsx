...
export default function TopologyEditor() {
 ...
 <Field label="출발 노드">
 <input className={`${INP} text-white/90`} readOnly value={addEdge.startNode ?? ""} />
 </Field>
 <Field label="도착 노드">
 <input className={`${INP} text-white/90`} readOnly value={addEdge.endNode ?? ""} />
 </Field>
 <Field label="방향">
 ...
 <div className="flex gap-1 mt-2">
 <button className={BTN("bg-blue-900/40 text-white/70 border-white/[0.05] hover:bg-blue-800/50 flex-1")} onClick={updateNode}>수정</button>
 ...
 <div className="flex gap-1 mt-2">
 <button className={BTN("bg-blue-900/40 text-white/70 border-white/[0.05] hover:bg-blue-800/50 flex-1")} onClick={updateEdge}>수정</button>
 ...
 <div className="px-3 py-4 text-xs text-white/30 leading-relaxed">
