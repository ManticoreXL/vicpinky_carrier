...
// ── 액션 정의 ───────────────────────────────────────────────────────────────
// 액션명은 도메인브리지 키(=허브 프록시) 및 로봇 서버명과 일치해야 한다.
// vicpinky 브리지: /ramp_control (from 49 → to 40, remap 없음) → 로봇 서버 /ramp_control.
// (이전 "/vicpinky/ramp_control"은 허브에 그런 프록시가 없어 goal이 전달 안 됐음 — clients:0)
const RAMP_ACTION = "/ramp_control";
